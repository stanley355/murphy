  ...
  return (
    <div className={styles.landing__cloudsolution}>
      <div className="container">
        ...
        <div className={styles.landing__cloudsolution__subtitle}>
          Marph offers two ways to solve your Web Hosting Problems:
        </div>
            ...
            <a title="Cloud Products" className={styles.landing__cloudsolution__card}>
              <div>
                <img
                  ...
                  alt="Cloud Products"
                  width={isDesktop ? 200 : 275}
                  height={isDesktop ? 100 : 135}
                />
              </div>
              <div>
                <div className={styles.landing__cloudsolution__card__title}>
                  Product/Plan Solution
                </div>
                <div className={styles.landing__cloudsolution__card__subtitle}>
                  Compare various web hosting plans or products from cloud hosting providers
                </div>
              </div>
            </a>
          </Link>
          <div className={styles.landing__cloudsolution__or}>
            <FaGripLines /> <FaGripLines /> OR <FaGripLines /> <FaGripLines />
          </div>
          ...
          <Link href="/calculation">
            <a title="Cloud Recommendation" className={styles.landing__cloudsolution__card}>
              ...
              <div>
                ...
                <div className={styles.landing__cloudsolution__card__subtitle}>
                  Fill in your application needs and select the most suitable cloud providers from
                  our recommendation
                </div>
              </div>
            </a>
